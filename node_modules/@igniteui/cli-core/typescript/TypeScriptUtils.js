...
class TypeScriptUtils {
    ...
    static createIdentifierImport(identifierNames, importPath) {
        ...
        const importDeclaration = ts.factory.createImportDeclaration(undefined, importClause, ts.factory.createStringLiteral(importPath), undefined);
    ...
    static createSourceFile(filePath, text, scriptTarget, setParentNodes) {
