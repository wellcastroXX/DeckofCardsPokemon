import { ApplicationRef, ComponentFactoryResolver, ElementRef, EventEmitter, Injector, NgZone, OnDestroy, Type, ViewContainerRef } from '@angular/core';
...
export declare class IgxOverlayService implements OnDestroy {
    ...
    constructor(_factoryResolver: ComponentFactoryResolver, _appRef: ApplicationRef, _injector: Injector, document: any, _zone: NgZone, platformUtil: PlatformUtil, animationService: AnimationService);
    /**
     ...
     */
    attach(component: Type<any>, settings?: OverlaySettings, moduleRef?: {
        injector: Injector;
